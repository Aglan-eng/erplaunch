...
export type JobType = 'BUSINESS_PROFILE' | 'SDF' | 'SUITESCRIPT' | 'TRAINING_DOCX' | 'RUNBOOK' | 'UAT_SCRIPTS' | 'HANDOFF_PACKAGE' | 'QUARTERLY_HEALTH_CHECK' | 'PROPOSAL' | 'SOW' | 'SALES_PERFORMANCE_REPORT' | 'MS_PROJECT_PLAN';
